...
class PointerEventPacket {
  ...
  /// [WidgetTester.handlePointerEventPack] call.
...
List<PointerEventPacket> pointerEventPackFromJson(String jsonString,
  ...
  return <PointerEventPacket>[
    for (final Map<String, dynamic> jsonObject in jsonObjects)
      PointerEventPacket.fromJson(jsonObject, devicePixelRatio,
